            ...
            <section className='flex flex-col items-center justify-center my-5'>
                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className='grid grid-cols-1'>
                        ...
                        <InputText id="name" onChange={formik.handleChange} placeholder="Type the Image name"></InputText>
                    </div>

                    <div className='mt-5 grid grid-cols-1'>
                        <label className='block text-sm font-medium leading-6 text-gray-700'>Tag: *</label>
                        <InputText id="tags" onChange={formik.handleChange} placeholder="Type the tag name"></InputText>
                    </div>
